		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/student ","root","9895971173");
					Statement stat=con.createStatement();
				//	String sql="Select * from login where username='"+textField.getText()+"'and password='"+passwordField.getText()+"'";
					String sql="SELECT username from student_data where password='"+passwordField.getText()+"'";
