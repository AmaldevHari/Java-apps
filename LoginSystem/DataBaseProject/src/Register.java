	...
	private void initialize() {
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/student ","root","9895971173");
				PreparedStatement st=conn.prepareStatement("insert into student_data(firstName,lastName,university,yearLevel,username,password)values(?,?,?,?,?,?)");
